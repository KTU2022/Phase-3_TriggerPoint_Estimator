...
Original file is located at
    https://colab.research.google.com/drive/1ENc_LbgdIeRSo2L_fvjW90y2NQo4E8qH
...
prec=nc.Dataset('/content/drive/MyDrive/Project/Phase 2/Database_new4/CMORPH_V1.0_ADJ_0.25deg-DLY_00Z_20200901.nc')
sst=nc.Dataset('/content/drive/MyDrive/Project/Phase 2/Database_new4/oisst-avhrr-v02r01.20200901.nc')
wind=nc.Dataset('/content/drive/MyDrive/Project/Phase 2/Database_new4/uv20200901rt.nc')
...
fc = model_fitted.forecast(y=forecast_input, steps=407719)
df_forecast = pd.DataFrame(fc, index=df3.index[:407719], columns=df3.columns + '_2d')
df_forecast

import geopy.distance

coords_1 = (-34.875,271.125) 
coords_2 = (59.875,350.125) 
...
df_forecast
df_forecast['tr'] = df_forecast[' ratio_2d']/12718
df_forecast
