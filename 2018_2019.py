...
Original file is located at
    https://colab.research.google.com/drive/1MMbtZfofWWNm80eMhQ8FJ1_6L1tGqBsc
...
prec=nc.Dataset('/content/drive/MyDrive/Project/Phase 2/Database_new3/PRECIPITATION_CMORPH_V1.0_ADJ_0.25deg-DLY_00Z_20190601.nc')
sst=nc.Dataset('/content/drive/MyDrive/Project/Phase 2/Database_new3/SST_oisst-avhrr-v02r01.20190601.nc')
wind=nc.Dataset('/content/drive/MyDrive/Project/Phase 2/Database_new3/WIND_uv20190601rt.nc')
...
forecast_input = df_train.values[-12:]
forecast_input
...
fc = model_fitted.forecast(y=forecast_input, steps=412189)
df_forecast = pd.DataFrame(fc, index=df3.index[:412189], columns=df3.columns + '_2d')
df_forecast

import geopy.distance

coords_1 = (-38.125,0.875)
coords_2 = (59.875,347.625)

print (geopy.distance.geodesic(coords_1, coords_2).km)

df_forecast['Lat_2d'] = df2['Lat']
df_forecast['Lon_2d'] = df2['Lon']
df_forecast
df_forecast['tr'] = df_forecast[' ratio_2d']/10929
df_forecast

from sklearn.preprocessing import MinMaxScaler
column = 'tr'
df_forecast[column] = MinMaxScaler().fit_transform(np.array(df_forecast[column]).reshape(-1,1))
df_forecast
...
for i in df_forecast.index:
  if(df_forecast['tr'][i] <= 0.04373):
    folium.CircleMarker(location = [df_forecast['Lat_2d'][i],df_forecast['Lon_2d'][i]], radius=5,fill =True).add_to(marker_cluster)
